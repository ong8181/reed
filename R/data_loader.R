...
data_loader <- function(dataset_name) {
  ...
  if (dataset_name == dataset_list[2]) {
    ...
    # Compile date
    ushio_2023a_elife_df_sample$site_code <- as.factor(ushio_2023a_elife_df_sample$site_code)
  ...
  if (dataset_name == dataset_list[3]) {
    ...
    # Compile date
    ushio_2023b_elife_df_sample$plot <- as.factor(ushio_2023b_elife_df_sample$plot)
